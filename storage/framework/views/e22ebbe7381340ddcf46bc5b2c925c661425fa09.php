                        ...
                        <tbody>
                            <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $indexKey => $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="item<?php echo e($post->id); ?> <?php if($post->is_published): ?> warning <?php endif; ?>">
                                    ...
                                    <td>
                                        <?php echo e(App\Post::getExcerpt($post->no_hp)); ?>

                                    </td>
                                    <td><?php echo e($post->produk); ?></td>
                                    <td><?php echo e($post->tgl_beli); ?></td>
                                    <td><?php echo e($post->konter); ?></td>
                                    ...
                                    <td>
                                        <button class="show-modal btn btn-success" data-id="<?php echo e($post->id); ?>" data-nama="<?php echo e($post->nama); ?>" data-no_hp="<?php echo e($post->no_hp); ?>" data-produk="<?php echo e($post->produk); ?>" data-tgl_beli="<?php echo e($post->tgl_beli); ?>" data-konter="<?php echo e($post->konter); ?>">
                                        <span class="glyphicon glyphicon-eye-open"></span> Tampilkan</button>
                                        <button class="edit-modal btn btn-info" data-id="<?php echo e($post->id); ?>" data-nama="<?php echo e($post->nama); ?>" data-no_hp="<?php echo e($post->no_hp); ?>" data-produk="<?php echo e($post->produk); ?>" data-tgl_beli="<?php echo e($post->tgl_beli); ?>" data-konter="<?php echo e($post->konter); ?>">
                                        <span class="glyphicon glyphicon-edit"></span> Edit</button>
                                        <button class="delete-modal btn btn-danger" data-id="<?php echo e($post->id); ?>" data-nama="<?php echo e($post->nama); ?>" data-no_hp="<?php echo e($post->no_hp); ?>" data-produk="<?php echo e($post->produk); ?>" data-tgl_beli="<?php echo e($post->tgl_beli); ?>" data-konter="<?php echo e($post->konter); ?>">
