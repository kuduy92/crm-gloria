...
<body>
    <div class="col-md-12 col-md-offset-0">
        ...
        <form style="border: 1px solid #a1a1a1;margin-top: 15px;padding: 10px;" action="<?php echo e(URL::to('importExcel')); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
